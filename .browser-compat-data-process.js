...
const fixCanIUseSpecURLs = (key, data) => {
  ...
  if (data && data instanceof Object && 'spec' in data) {
    ...
    specURL = specURL
      .replace("https://www.w3.org/TR/DOM-Level-3-XPath/xpath.html#XPathEvaluator-evaluate",
      ...
      .replace('w3.org/TR/css3-fonts/#font-rend-props', 'drafts.csswg.org/css-fonts/#font-rend-props')
      ...
      .replace('css-contain-1/#contain-property', 'css-contain/#contain-property')
      .replace('css-contain-2/#content-visibility', 'css-contain/#content-visibility')
      ...
      .replace('https://www.w3.org/TR/SVG11/extend.html#ForeignObjectElement', 'https://svgwg.org/svg2-draft/embedded.html#ForeignObjectElement')
      .replace('https://www.w3.org/TR/SVG11/linking.html#SVGFragmentIdentifiers', 'https://svgwg.org/svg2-draft/linking.html#SVGFragmentIdentifiers')
    ;
    specURL = specURL
...
const getMdnSlug = (mdnURL, feature) => {
  if (mdnURL.toLowerCase().startsWith('https://developer.mozilla.org/en-us/docs/web/')) {
    mdnURL = mdnURL.substring(45);
  } else if (mdnURL.toLowerCase().startsWith('https://developer.mozilla.org/en-us/docs/learn/')) {
...
const processSpecURL = (url, feature, bcdData, mdnURL, mdnData) => {
  ...
  const summary = mdnData.doc.summary.replace(/\u00A0/g, ' ')
    .replaceAll('\n', ' ').replace(/\s+/g, ' ');
